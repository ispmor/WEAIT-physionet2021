    ...
    def create_stack(self, stack_id):
        ...
        for block_id in range(self.nb_blocks_per_stack):
            ...
            if self.share_weights_in_stack and block_id != 0:
                ...
                block = block_init(self.hidden_layer_units, self.thetas_dim[stack_id], self.input_size, self.target_size, classes=len(self.classes))
...
class Nbeats_beta(nn.Module):
    def __init__(self,
        ...
        self.fc = nn.Linear(input_size * self.linea_multiplier + 363 * self.linea_multiplier + self.linea_multiplier, num_classes)  # hidden_size, 128)  # fully connected 1# fully connected last layer
